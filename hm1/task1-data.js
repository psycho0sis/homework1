//    1. Дано массив users с данными о пользователях интернет магазина. 
//       Нужно пройтись по этому массиву и вывести в консоль только пользователей, которые зарегистрировались 9 и 10 октября 2021 года.
